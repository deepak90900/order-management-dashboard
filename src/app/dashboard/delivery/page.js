...
export default function DeliveryPage() {
  ...
  useEffect(() => {
    // Fetch orders in the "Delivery" stage from the backend
    const fetchOrders = async () => {
      const response = await fetch("/api/orders?stage=Delivery");
  ...
  const handleComplete = async (orderId) => {
    ...
    // Update the order's stage to "Finished"
